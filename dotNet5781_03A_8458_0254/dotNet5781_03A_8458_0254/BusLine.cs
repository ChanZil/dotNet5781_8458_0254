...
namespace dotNet5781_02_8458_0254
{
    class BusLine: IComparable
    {
        ...
        public List<BusStopLine> stations=new List<BusStopLine>(); //a list of all the stations in the bus line
        ...
        public BusLine(int busLine, List<BusStopLine> station , string area) //ctor
        {
            ...
            this.area = area;
            int count = 0;
            foreach (BusStopLine item in station)
            {
        ...
        public override string ToString() //override function ToString
        {
            ...
            foreach(BusStopLine item in this.stations) //pass the stations list to return the details of each station
